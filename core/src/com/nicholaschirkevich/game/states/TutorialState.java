...
public class TutorialState extends State implements OnSetCollisionCars, ResumeFromPause, OnTrafficLightListener, OnCrushCarListener, OnGearUp, ResumeButtonListener, PauseButton.pauseButtonListener, PauseAfterCollision, UpdateCoinCount, OnStartRelaxZone, ListenerAddBoost, ListenerAddLadle, GenerateHoleAfterLadle, SetGodMode, ZoomCarListener, DirtListener, CarTurnInterface {
    ...
    public TutorialState(GameStateManager gsm, boolean isNeedTutorial, boolean isFromGarage, ActionResolver actionResolver) {
        super(gsm);
...
//    }
    ...
    public void setUpAchivesCountLabel() {
        ...
        labelAchives.setBounds(GameRuners.WIDTH / 2 - 160 - labelAchives.getPrefWidth() / 2, GameRuners.HEIGHT / 2 - 30, labelAchives.getWidth(), labelAchives.getHeight());
...
//                        });
                        ...
                        ToastHelper.showUpMessage(GameManager.getStrings().get(Constants.GAME_DANGEROUS_LBL), "+50", Color.ORANGE, Color.WHITE, ToastLength.TOAST_LONG);
