 ...
 */
public class ToastRectangle extends Actor {
    private ShapeRenderer shapeRenderer;
    private float mainRectX = 21, mainRectY = 150, mainRectWidth = 280 , mainRectHeight = 145;
    ...
    private float buttonBorderX = mainRectX + 4, buttonBorderY = mainRectY + 54, buttonBordertWidth = mainRectWidth - 8, buttonBorderHeight = 4;
    private float buttonDelimiterBorderX = mainRectX + 140, buttonDelimiterBorderY = mainRectY+4, buttonDelimiterBorderWidth =4, buttonDelimiterBorderHeight = 52;
    private float imageBorderRectX = mainRectX + 36, imageBorderRectY = mainRectY + 91, imageBorderWidth = mainRectWidth - 52, imageBorderRectHeight = mainRectHeight - 122;
...
//        shapeRenderer.end();
        ...
        shapeRenderer.begin(ShapeRenderer.ShapeType.Filled);
        shapeRenderer.setColor(Color.BLACK.r, Color.BLACK.g, Color.BLACK.b, alfa);
        shapeRenderer.rect(buttonBorderX, buttonBorderY, buttonBordertWidth, buttonBorderHeight);
        shapeRenderer.end();
        shapeRenderer.setProjectionMatrix(batch.getProjectionMatrix());
        shapeRenderer.begin(ShapeRenderer.ShapeType.Filled);
        shapeRenderer.setColor(Color.BLACK.r, Color.BLACK.g, Color.BLACK.b, alfa);
        shapeRenderer.rect(buttonDelimiterBorderX, buttonDelimiterBorderY, buttonDelimiterBorderWidth, buttonDelimiterBorderHeight);
        shapeRenderer.end();
